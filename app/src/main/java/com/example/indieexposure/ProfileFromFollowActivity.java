...
public class ProfileFromFollowActivity extends AppCompatActivity implements PostAdapter.OnPostClickListener{
    ...
    public void onClick(int position) {
        ...
        Intent intent = new Intent(ProfileFromFollowActivity.this, PostActivity.class);
